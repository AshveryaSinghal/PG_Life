...
INSERT INTO interested_users_properties (id, property_id, user_id) VALUES
...
INSERT INTO `properties_amenities` (`id`, `property_id`, `amenity_id`) VALUES
-- Property 10
(85, 10, 1), (86, 10, 2), (87, 10, 5), (88, 10, 7), (89, 10, 10), (90, 10, 13), (91, 10, 4), (92, 10, 9), (93, 10, 11), (94, 10, 12),

-- Property 11
(95, 11, 1), (96, 11, 2), (97, 11, 5), (98, 11, 7), (99, 11, 10), (100, 11, 13), (101, 11, 8), (102, 11, 11),

-- Property 12
(103, 12, 1), (104, 12, 2), (105, 12, 5), (106, 12, 7), (107, 12, 10), (108, 12, 13), (109, 12, 3), (110, 12, 4), (111, 12, 9), (112, 12, 12),

-- Property 13
(113, 13, 1), (114, 13, 2), (115, 13, 5), (116, 13, 7), (117, 13, 10), (118, 13, 13), (119, 13, 4), (120, 13, 11),

-- Property 14
(121, 14, 1), (122, 14, 2), (123, 14, 5), (124, 14, 7), (125, 14, 10), (126, 14, 13), (127, 14, 3), (128, 14, 8), (129, 14, 12),

-- Property 15
(130, 15, 1), (131, 15, 2), (132, 15, 5), (133, 15, 7), (134, 15, 10), (135, 15, 13), (136, 15, 4), (137, 15, 11), (138, 15, 9),

-- Property 16
(139, 16, 1), (140, 16, 2), (141, 16, 5), (142, 16, 7), (143, 16, 10), (144, 16, 13), (145, 16, 3), (146, 16, 8), (147, 16, 9), (148, 16, 12),

-- Property 17
(149, 17, 1), (150, 17, 2), (151, 17, 5), (152, 17, 7), (153, 17, 10), (154, 17, 13), (155, 17, 4), (156, 17, 12),

-- Property 18
(157, 18, 1), (158, 18, 2), (159, 18, 5), (160, 18, 7), (161, 18, 10), (162, 18, 13), (163, 18, 3), (164, 18, 11),

-- Property 19
(165, 19, 1), (166, 19, 2), (167, 19, 5), (168, 19, 7), (169, 19, 10), (170, 19, 13), (171, 19, 4), (172, 19, 8), (173, 19, 12),

-- Property 20
(174, 20, 1), (175, 20, 2), (176, 20, 5), (177, 20, 7), (178, 20, 10), (179, 20, 13), (180, 20, 3), (181, 20, 9), (182, 20, 11), (183, 20, 12);





ALTER TABLE users ADD COLUMN profile_img VARCHAR(255) DEFAULT 'uploads/default.jpg';
ALTER TABLE testimonials ADD COLUMN review_image VARCHAR(255) DEFAULT NULL;
ALTER TABLE testimonials ADD COLUMN profile_img VARCHAR(255) DEFAULT NULL;
ALTER TABLE testimonials ADD FOREIGN KEY (user_id) REFERENCES users(id);
